...
<body>
    <div id="app">
        <div class="flex p-10">
            <div class="w-full mr-5">
                ...
                <div class="flex text-list">
                    ...
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v500" @change="updateSubTotal(500)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st500 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">200</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v200" @change="updateSubTotal(200)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st200 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">100</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v100" @change="updateSubTotal(100)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st100 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">50</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v50" @change="updateSubTotal(50)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st50 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">20</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v20" @change="updateSubTotal(20)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st20 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">10</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v10" @change="updateSubTotal(10)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st10 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">5</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v5" @change="updateSubTotal(5)" name="" id=""></div>
                    <div class="w-1/2 pl-20">{{ st5 }}</div>
                </div>

                <div class="flex text-list">
                    <div class="w-1/2">1</div>
                    <div class="w-1/2"><input type="tel" maxlength="4" v-model="v1" @change="updateSubTotal(1)" name="" id=""></div>
        ...
        <div class="flex px-10">
            <button class="btn btn-primary px-3 py-1 mr-5" @click="resetValues">Clear</button>
            <button class="btn btn-default px-3 py-1" @click="printCounts">Print</button>
        </div>
    </div>
